...
1. Clone the repo
   ```sh
   git clone https://github.com/Rai321han/Expense-Tracker-Project.git
   ```
...
[Project Link](https://github.com/Rai321han/Expense-Tracker-Project)
...
[product-screenshot]: ./public/assets/image/banner.png
